        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-sm hover:text-primary transition-colors">Премиум линия</Link></li>
              <li><Link href="#" className="text-sm hover:text-primary transition-colors">Детские футболки</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-sm hover:text-primary transition-colors">Отзывы клиентов</Link></li>
              <li><Link href="#" className="text-sm hover:text-primary transition-colors">Партнерам</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="mailto:info@rubolka.ru" className="text-sm hover:text-primary transition-colors flex items-center space-x-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span>info@rubolka.ru</span>
                </a>
              </li>
